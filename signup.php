...
<form method="post" action="signup.php">
  ...
  <b>Email:</b> <br> <input type="Email" name="" id="field" placeholder="Email" style="border-radius: 5px;padding-left: 10px;font-size: 18px; border-color:#97455F; " required><br><br>
  ...
  <b>Re-Password:</b> <br><input type="password" name="" id="field" placeholder="Re-Password" style="border-radius: 5px;padding-left: 10px;font-size: 18px; border-color:#97455F; " required><br><br>
  <input type="checkbox" name="" id="check"  required> I understand the terms and conditions.<br> <br>

  
  <input type="submit" name="" value="Register" id="ssubmit" style="border-color: #97455F; border-radius: 5px; font-size:15px;"> 
  </p>
